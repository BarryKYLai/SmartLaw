...
judgement_path = "E:\\KuiYou\\data\\intellectual-property-court-clean" # 一次匯入所有資料集
...
model = load_model('E:\\KuiYou\\my python project\\LSTM_model.h5')
X = model.predict_classes(X_train)
print('test after load: ', X)